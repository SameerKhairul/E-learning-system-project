...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3xl font-medium text-gray-800'>System Reviews</h2>
      <p className='md:text-base text-gray-500 mt-3'>Hear what experts had to say about our innovative E-learning system.</p>
